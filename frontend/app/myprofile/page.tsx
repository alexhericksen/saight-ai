    ...
    <div className="min-h-screen p-6 bg-white text-black">
      ...
      <div className="flex justify-between items-center border-b pb-6">
        <div className="flex items-center space-x-6">
          <img src="/placeholder-profile.png" className="h-20 w-20 rounded-full border" alt="Profile" />
          <div>
        ...
        {activeTab === "profile" && (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 p-4 rounded-xl shadow">Top Tools (chart placeholder)</div>
              <div className="bg-gray-50 p-4 rounded-xl shadow">Top Uses (chart placeholder)</div>
            </div>
